...
public class GraphBFS {
    ...
    public static boolean listDFS() {
        Integer[] expected = {0, 1, 4, 5, 6};
        Integer[] actual = structures.GraphBFS.listDFS(Constants.list2, 0, 6);
        boolean findsPath = Arrays.equals(expected, actual);
        ...
        Integer[] res = structures.GraphBFS.listDFS(Constants.list2, 6, 0);
